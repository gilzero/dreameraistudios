      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="md:grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <motion.h3
              className={cn(
                applyTypography.heading.h3(
                  'mb-8 bg-clip-text text-transparent bg-gradient-to-r from-apple-gray-500 to-apple-gray-300'
                )
              )}
              ...
              {[
                ...
                <motion.p
                  ...
                  className={cn(
                    ...
                    'text-apple-gray-300 font-light leading-relaxed flex items-start'
                  )}
                  variants={itemVariants}
                >
                  <span className="text-apple-blue-primary mr-3 text-lg font-medium">
                    →
                  </span>
                  {text}
                </motion.p>
            ...
            <motion.div variants={itemVariants}>
              ...
              <p
                className={cn(
                  typography.body.medium,
                  'mt-6 text-apple-gray-300 font-light'
                )}
              >
