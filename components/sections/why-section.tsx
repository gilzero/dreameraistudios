  ...
  const reasonsData = [
    {
      ...
      description:
        'Beyond computation lies creation - the ability to generate new ideas and perspectives that transcend their inputs.',
    },
    {
      title: 'Intelligence that inspires rather than automates',
      description:
        'AI should inspire human creativity, not replace it. Our approaches aim to elevate human potential.',
    },
    {
      title: 'Intelligence that dreams',
      description:
        'The ultimate frontier is AI that can imagine possibilities beyond its programming - intelligence that dreams.',
    },
  ];
          ...
          >
            <motion.p
              className={cn(
                ...
                typography.serif,
                'mb-4 text-apple-gray-500 font-light'
              )}
              variants={titleVariants}
              initial="hidden"
              animate={isIntersecting ? 'visible' : 'hidden'}
            ...
            >
              Artificial intelligence is neither merely artificial nor simply
              intelligent. It's human knowledge transformed and transcended
              through computation. 'Move 37' is a step in the universe.
            </motion.p>
          </motion.div>
        </div>
