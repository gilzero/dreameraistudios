 ...
 */
export default function DesignGuide(): JSX.Element {
  return (
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <section className="mb-16">
        <h2 className={applyTypography.heading.h2('mb-6 text-apple-gray-500')}>
          Typography
        </h2>
        ...
        <div className="mt-8">
          ...
          <div className="space-y-4 bg-apple-gray-100 p-4 rounded-lg">
            <p className="text-apple-gray-500 font-mono text-sm">
              {`// Using applyTypography utility function`}
              <br />
      ...
      <section className="mb-16">
        ...
        <div className="mt-8">
          ...
          <div className="space-y-4 bg-apple-gray-100 p-4 rounded-lg">
            <p className="text-apple-gray-500 font-mono text-sm">
              {`// Using getColor utility function`}
              <br />
          ...
          <div className="mt-4 flex space-x-4">
            {Object.entries(opacities).map(([name, value]) => (
              <div key={name} className="text-center">
                <div
                  className={cn(
                    'w-16 h-16 rounded-lg mx-auto',
                    `bg-apple-blue-primary/${value}`
                  )}
                ></div>
      ...
      <section className="mb-16">
        ...
        <div className="space-y-12">
          ...
          <div>
            ...
            <div className="mt-4">
              <h4
                className={applyTypography.heading.h4(
                  'mb-2 text-apple-gray-500'
                )}
              >
                Sizes
              </h4>
              <div className="flex flex-wrap gap-4 items-center">
                ...
                <AppleButton variant="primary" size="xl">
                  Extra Large
                </AppleButton>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <AppleCard variant="glass" padding="lg" hover="lift">
                <AppleCardHeader>
                  ...
                  <AppleCardDescription>
                    This card has a glass effect and lifts on hover.
                  </AppleCardDescription>
                </AppleCardHeader>
                <AppleCardContent>
                  <p className="text-apple-gray-300">Card content goes here.</p>
              ...
              <AppleCard variant="elevated" padding="lg" hover="scale">
                <AppleCardHeader>
                  ...
                  <AppleCardDescription>
                    This card is elevated and scales on hover.
                  </AppleCardDescription>
                </AppleCardHeader>
                <AppleCardContent>
                  <p className="text-apple-gray-300">Card content goes here.</p>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <AppleInput label="Name" placeholder="John Appleseed" />
      ...
      <section className="mb-16">
        ...
        <AppleCard variant="glass" padding="lg">
          ...
          <ul className="list-disc pl-6 space-y-2 text-apple-gray-300">
            <li>
              Use the typography system consistently across all components.
            </li>
            <li>
              Apply typography using the{' '}
              <code className="bg-apple-gray-100 px-1 py-0.5 rounded">
                applyTypography
              </code>{' '}
              utility function.
            </li>
        ...
        <AppleCard variant="glass" padding="lg" className="mt-6">
          ...
          <ul className="list-disc pl-6 space-y-2 text-apple-gray-300">
            <li>
              Always use the color system variables instead of direct hex
              values.
            </li>
            <li>
              Use the{' '}
              ...
              utility for consistent opacity values.
            </li>
            <li>
              Maintain consistent text colors: primary text should use{' '}
              <code className="bg-apple-gray-100 px-1 py-0.5 rounded">
                text-apple-gray-500
              </code>
              .
        ...
        <AppleCard variant="glass" padding="lg" className="mt-6">
          ...
          <ul className="list-disc pl-6 space-y-2 text-apple-gray-300">
            <li>
              Use AppleCard components consistently with appropriate variants.
            </li>
            <li>
              Maintain consistent padding and hover effects across similar
              elements.
            </li>
            <li>
              Use the same animation parameters (appleEasing) for all
              animations.
            </li>
          </ul>
        </AppleCard>
